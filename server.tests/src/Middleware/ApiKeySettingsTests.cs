...
public class ApiKeySettingsTests
{
    ...
    public void IsValidApiKey_ExactMatch_Succeeds()
    {
        ...
        {
            Keys = new List<string> { ValidKey1 }
        };

        // Act
        var result = settings.IsValidApiKey(ValidKey1);
    ...
    public void IsValidApiKey_CaseMismatch_Fails()
    {
        ...
        // Act
        var result = settings.IsValidApiKey(ValidKey1.ToUpperInvariant());
    ...
    public void IsValidApiKey_MultipleKeys_FirstKeySucceeds()
    {
        ...
        var settings = new ApiKeySettings
        {
            Keys = new List<string> { ValidKey1, ValidKey2 }
        };
    ...
    public void IsValidApiKey_MultipleKeys_SecondKeySucceeds()
    {
        ...
        // Act
        var result = settings.IsValidApiKey(ValidKey2);
    ...
    public void IsValidApiKey_MultipleKeys_InvalidKeyFails()
    {
        ...
        // Act
        var result = settings.IsValidApiKey(InvalidKey);
    ...
    public void IsValidApiKey_WhitespaceKey_Fails()
    {
        ...
        // Act
        var result = settings.IsValidApiKey("   ");
    ...
    public void IsValidApiKey_EmptyString_Fails()
    {
        ...
        // Act
        var result = settings.IsValidApiKey(string.Empty);
    ...
    public void IsValidApiKey_NullKey_Fails()
    {
        ...
        // Act
        var result = settings.IsValidApiKey(null!);
    ...
    public void IsValidApiKey_PartialMatch_Fails()
    {
        ...
        var result = settings.IsValidApiKey(ValidKey1.Substring(0, 5));
